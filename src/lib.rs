...
#[derive(Debug)]
pub struct WalletConnectProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WalletConnectProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WalletConnect processing");
    
    let mut processor = WalletConnectProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WalletConnectProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WalletConnectProcessor::new(false);
